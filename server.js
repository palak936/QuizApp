...
MongoClient.connect("mongodb://127.0.0.1:27017/")
  .then((client) => {
    ...
    htmlcollection = db.collection("HtmlQuestion");
    javaScriptcollection = db.collection("javascriptQuestion");
    linuxcollection = db.collection("LinuxQuestion");
    dbmscollection = db.collection("DbmsQuestion");
  })
  .catch((error) => {
